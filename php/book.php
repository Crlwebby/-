...
$che=mysqli_query($conn,"select 状态 from roomstatus where 房间号 = '$number' and 状态 = '已入住'");
...
$sql1="update roomstatus set 状态='已入住' where 房间号='".$number."'";
$res1=mysqli_query($conn,$sql1);
$res = mysqli_query($conn, $sql);
if ($res1&&$res){
    exit ('注册成功，点击此处<br/><a href=../html/book.html>返回功能表</a>');
}
else{
